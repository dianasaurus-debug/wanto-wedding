                        ...
                        <div class="-mx-3 md:flex mb-4">
                            <div class="md:w-1/2 px-3">
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input v-model="form.harga"  name="price" id="price"
                            ...
                            <div class="md:w-1/2 px-3">
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input v-model="form.nominal_dp" name="price" id="dp"
                                           class="appearance-none block w-full pl-9 pr-12 sm:text-sm bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3"
...
<!--                        </div>-->
                        <div class="flex flex-row-reverse ...">
                            <div>
                                <!-- Using utilities: -->
                                <button :href="route('jasa.index')"  class="mr-2 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                                    Batal
                                </button>
                            </div>
                            <div class="mr-2">
...
export default defineComponent({
    ...
    created(){
        this.form.nama= this.product.nama;
            this.form.harga= this.product.harga;
            this.form.deskripsi= this.product.deskripsi;
            this.form.category_id= this.product.category_id;
            this.form.cover= this.product.cover;
            this.form.image_posts= [];
            this.form.nominal_dp= this.product.nominal_dp
    },
    props: ['product','allkategori'],
    data: function () {
        return {
            form: {
                nama: null,
    ...
    methods: {
        ...
        save_product() {
            ...
            this.$inertia.post('/jasa/'+this.product.id, data, {
                forceFormData: true,
            });
        }
    }
